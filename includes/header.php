...
?></span></li>          
        ...
        <div class="head-right">
          ...
          <ul class="number">
            <li><a href="spiritual-teachings.php">Spritual Teachings </a></li>|
    ...
    <div class="header-bottom">
      <div class="container">
        <div class="logo">
          <a href="index.php" style="text-align:center;"><img src="images/logo.jpg" class="img-responsive" alt="" width="100" height="50" />
            <h4 style="font-weight:bold; padding-top:1%; font-size:24px;"> ISKCON - Hare Krishn, Hare Ram </h4></a>
        </div>
        ...
        <div class="head-na">
          ...
          <span class="menu"> </span>
            <ul class="cl-effect-15">
                ...
                <li><a href="volunteer-registration.php" data-hover="VOLUNTEER">VOLUNTEER REGISTRATION</a></li><label>|</label>
