...
<html>
<head>
<title>	TEMPLE MANAGEMENT | | Donation</title>
...
<script src="js/jquery.min.js"></script>
  <script type="text/javascript">
    ...
    function showImage(){
    	var paymentOption = document.getElementsByName("paymentoption")[0].value;
	...
	function init() {
    	var paymentOptionDropdown = document.getElementsByName("paymentoption")[0];
    	paymentOptionDropdown.addEventListener("change", showImage);
	...
	function init() {
		var paymentOptionDropdown = document.getElementsByName("paymentoption")[0];
		paymentOptionDropdown.addEventListener("change", showCardInput);
		showCardInput(); // Call showCardInput initially to set the initial state based on the selected option
	}
	...
	/*{
        ...
        if (paymentOption === "UPI") {
			...
			document.getElementById('loadingImage').style.visibility = "hidden";
            //alert("Please select UPI option to view QR code.");
            }
        // document.getElementById('loadingImage').style.visibility="visible"; 
    }*/
								...
								<div class="contact-form-row">
									...
									<div>
										...
										<select type="text" class="form-control" value="" name="paymentoption" required="true">
											...
											<!-- Box beside payment option -->
											<div id="cardInput">
												<input type="text" placeholder="Enter Card Number" class="form-control" value="" name="cardnumber" required="true">
											</div>
									       <!-- End of box -->

										<input type="button"  value="SHOW" onclick="showImage();"/> <font color="red">*After Choosing UPI QR Click Here </font>
										
										<table align="right"><tr><<img id="loadingImage"  src="images/PaytmQr.jpeg" height="200" style="visibility:hidden"/></td></tr></table>
