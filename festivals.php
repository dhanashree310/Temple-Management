...
<html>
<head>
<title>Temple Management || Festivals</title>
...
<table class="table table-striped">
    <tr>
        <th width="250"><h3 style="color:black; font-weight:bold;">Festival Name</h3></th>
        <td colspan="3"><h3 style="color:black; font-weight:bold;"><?php echo htmlentities($row['FestivalName']);?></h3></td>
    </tr>
    <tr>
