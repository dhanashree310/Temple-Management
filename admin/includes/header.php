<nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <h4 style="color: white; font-weight: bolder; padding-right: 20px;padding-left: 20px;padding-top:11px">ISKCON: Hare Krishn Hare Ram</h4>
          </div>
          <?php
$admid=$_SESSION['aid'];
...
?>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item">
              <h4 class="mb-0 font-weight-bold d-none d-xl-block" style="color: white;">Time: <?php
